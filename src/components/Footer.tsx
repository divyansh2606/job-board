        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/jobs" className="text-gray-300 hover:text-blue-400 transition">
                  Find Jobs
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/admin/login" className="text-gray-300 hover:text-blue-400 transition">
                  For Employers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">123 Job Street, Career City, Workplace 12345</span>
              </li>
